...
public class SupervisorSession extends Session {
	...
	/**
	* Changes a user's data to the new submitted data if he is a Member.
	* If the user doesn't exist, a new one is created.
	* This method is used by ChocAn's supervisors to update or create members.
	* @param userID number that identifies a unique user
	* @param name name of the user
	* @param pass password of the user
	* @param address physical address of the user
	* @param status int that defines whether the user is active, late for payment or disabled
	*/
...
/**
* Will create or modify a supervisor's data based on its userID.
* @param userID number that identifies a unique user
* @param name name of the user
* @param pass password of the user
*/
	...
	/**
	* Will create or modify a supplier's data based on its userID.
	* @param userID number that identifies a unique user
	* @param name name of the user
	* @param pass password of the user
	* @param address physical address of the user
	*/
	...
	/**
	* Will create or modify a services's data based on its servID.
	* @param servID number that identifies a unique service
	...
	*/
	...
	/*
	 * Will change the current GUI to the Users' GUI. Supervisor will be able
	 * to add, modify or delete all types of users through it.
	 *
	...
	/*
	 * Will change the current GUI to the Members' GUI. Supervisor will be able
	 * to update Members' personal information and status or delete them.
	 *
	 * @param UI current UI, to be modified by method.
	 */
	private void memberUI(UserInterface UI) {
		...
		num.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				...
				if (user != null && user.getClass().getName().equals("Member")) {
					...
					case Member.STATUS_VALID:
						status.setSelectedItem("Valide");
						break;
					case Member.STATUS_SUSPENDED:
						status.setSelectedItem("Suspendu");
						break;
					case Member.STATUS_LATEPAYMENT:
		...
		val.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				case "Valide":
					stat = Member.STATUS_VALID;
					break;
				case "En retard":
					stat = Member.STATUS_LATEPAYMENT;
					break;
				case "Suspendu":
					stat = Member.STATUS_SUSPENDED;
					break;
	...
	/*
	 * Will change the current GUI to the Suppliers' GUI. Supervisor will be able
	 * to update Suppliers' personal information or delete them.
	 *
	 * @param UI current UI, to be modified by method.
	 */
	...
	/*
	 * Will change the current GUI to the Supervisors' GUI. Supervisor will be able
	 * to update Supervisors' personal information and delete them.
	 *
	 * @param UI current UI, to be modified by method.
	 */
