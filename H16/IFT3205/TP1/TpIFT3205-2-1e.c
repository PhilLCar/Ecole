...
#define NAME_IMG_OUT    "image-TpIFT3205-2-1e"
...
int main(int argc,char **argv)
{
  ...
  BarFilter(imgR, width, length, 20, 0, FILTER_OUT | FILTER_VERTICAL);
  BarFilter(imgI, width, length, 20, 0, FILTER_OUT | FILTER_VERTICAL);
  ...
  printf("\nNuméro 2.1 e) terminé avec succès\n\n");
  return 0; 	 
}
